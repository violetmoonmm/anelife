...
#define kLLLineColor [UIColor colorWithRed:0.0/255.0 green:183.0/255.0 blue:238.0/255.0 alpha:0.8] // 线条色蓝
...
- (void)initCircles
{
    ...
    NSInteger numOfPoint = 3;//圆点行/列个数
    NSInteger kCircleDiameter = 68;//圆点长宽
    NSInteger kCircleMargin = (CGRectGetWidth(self.bounds)-numOfPoint*kCircleDiameter)/(numOfPoint-1);//圆点间隔
    
    // 初始化圆点
    for (int i = 0; i < 9; i++) {
        UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
//        int x = kCircleMargin + (i%3) * (kCircleDiameter+(CGRectGetWidth(self.bounds)-kCircleMargin*2- kCircleDiameter *3)/2);
//        int y = kCircleMargin + (i/3) * (kCircleDiameter+(CGRectGetHeight(self.bounds)-kCircleMargin*2- kCircleDiameter *3)/2);
