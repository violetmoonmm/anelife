...
- (void)initCircles
{
    ...
    NSInteger kCircleDiameter = 10;//圆点长宽
    ...
    for (int i=0; i<9; i++) {
        ...
        [button setBackgroundImage:[UIImage imageNamed:@"circle_indicator_normal"] forState:UIControlStateNormal];
        [button setBackgroundImage:[UIImage imageNamed:@"circle_indicator_selected"] forState:UIControlStateSelected];
