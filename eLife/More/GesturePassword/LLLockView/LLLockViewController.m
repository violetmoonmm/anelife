...
@property (nonatomic, strong) IBOutlet LLLockIndicator* indicator; // 九点指示图
@property (nonatomic, strong) IBOutlet LLLockView* lockview; // 触摸田字控件
@property (nonatomic,strong) IBOutlet UILabel *tipLable;

@property (nonatomic, strong) IBOutlet UIImageView *profileView;//头像
...
{
    [self.indicator setPasswordString:self.passwordNew];
}
