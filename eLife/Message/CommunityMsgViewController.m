...
@interface CommunityMsgViewController () <UITableViewDataSource,UITableViewDelegate>
{
...
@implementation CommunityMsgViewController
@synthesize  records;
...
//    _tblView.backgroundColor = [UIColor colorWithRed:235/255. green:235/255. blue:235/255. alpha:1];
    ...
    [Util unifyStyleOfViewController:self withTitle:@"社区信息"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //标题
    UILabel *titleLbl = [[UILabel alloc] initWithFrame:CGRectMake(10, 0, 220, TITLE_HEIGHT)];
    titleLbl.text = @"公共消息";
    ...
    //缩略图
    EGOImageView *thumbnail = [[EGOImageView alloc] initWithPlaceholderImage:[UIImage imageNamed:@"community.png"] delegate:nil];
